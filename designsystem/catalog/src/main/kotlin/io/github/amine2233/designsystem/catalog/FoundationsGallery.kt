...
@Preview(name = "foundations", device = "spec:width=375dp,height=780dp,dpi=420", showBackground = true)
@Composable
private fun FoundationsGalleryPreview() = DsTheme { FoundationsGallery() }
